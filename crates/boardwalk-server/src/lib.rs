...
pub use boardwalk_peer::PeerAcceptors;
use boardwalk_peer::PeerClient;
use boardwalk_registry::{DeviceRecord, Registry};
use url::Url;
use uuid::Uuid;
...
impl Boardwalk {
    ...
    pub fn build(self) -> anyhow::Result<Built> {
        ...
        let peer_senders: Arc<dyn boardwalk_http::PeerSenders> = Arc::new(acceptors.clone());
        let peer_streams = boardwalk_http::PeerStreamHub::new();
...
pub struct Built {
    ...
    pub peer_streams: boardwalk_http::PeerStreamHub,
